		...
		<section id="addtransaction" className="flex flex-col p-4 mx-4 bg-gray-100 border">
			...
			<div className="relative flex flex-col items-center h-full py-10 mx-auto rounded-sm sm:items-stretch sm:flex-row">
				...
				<button
					...
					className="inline-flex items-center justify-center h-12 px-6 font-medium text-gray-900 transition duration-200 bg-purple-300 rounded shadow-md hover:bg-purple-200 focus:shadow-outline focus:outline-none"
						...
						<div className="relative flex flex-col w-full bg-white border-0 rounded-lg shadow-lg outline-none focus:outline-none">
							...
							<div className="flex items-start justify-between p-5 border-b border-solid rounded-t border-blueGray-200">
								...
								<button
									...
									title="Close Menu"
									className="object-right p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
							...
							{/*<div className="flex items-center justify-end p-6 border-t border-solid rounded-b border-blueGray-200">
								...
								<button
									className="px-6 py-3 mb-1 mr-1 text-sm font-bold text-white uppercase transition-all duration-150 ease-linear bg-green-300 rounded shadow outline-none active:bg-emerald-600 hover:shadow-lg focus:outline-none"
									type="button">
									Add
								</button>
							</div>*/}
